...
/* For lighting*/
//LIGHT0
GLfloat color0[]={1.0,1.0,1.0,1.f};
GLfloat color1[]={1.0,0.55,0.65,1.f};
GLfloat color2[]={0.2,0.6,0.95,1.f};//光源颜色
GLfloat position0[]={0.f,76.f,0.f,1.f};//光源位置
GLfloat diff0[]={1.0,0.0,0.0,1.f};//漫射光成分
GLfloat direction0[]={0.0,0.0,100.f}; //光线向量
GLfloat exponent0[]={10.f}; //聚光程度
...
void init(void) // All Setup For OpenGL Goes Here 
{
	...
	quadobj = gluNewQuadric();//鍒涘缓浜屾鏇查潰瀵硅薄
